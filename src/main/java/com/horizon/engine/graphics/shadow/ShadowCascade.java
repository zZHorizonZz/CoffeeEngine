...
public @Data class ShadowCascade {
    ...
    public ShadowCascade(float zNear, float zFar) {
        ...
        this.orthographicProjectionMatrix = new Matrix4f();
    ...
    public void update(Window window, Matrix4f viewMatrix, DirectionalLight light) {
        ...
        Vector3f lightDirection = light.getDirectionalLight().getDirection();
    ...
    private void updateLightProjectionMatrix() {
        ...
        orthographicProjectionMatrix.setOrtho(minX, maxX, minY, maxY, 0, distz);
    }
}
